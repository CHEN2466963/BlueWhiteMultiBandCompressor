...
//==============================================================================
SpectrumAnalyzer::SpectrumAnalyzer(CompressorAudioProcessor& p) :
    audioProcessor(p),
...
void SpectrumAnalyzer::paint(juce::Graphics& g)
{
    ...
    auto bounds = drawModuelBackground(g, getLocalBounds());
...
void SpectrumAnalyzer::drawCrossovers(juce::Graphics& g, juce::Rectangle<int> bounds)
{
    ...
    g.setColour(Colour(0xff3acede).withAlpha(0.3f));
