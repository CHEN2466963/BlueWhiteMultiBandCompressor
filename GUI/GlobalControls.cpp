...
GlobalControls::GlobalControls(juce::AudioProcessorValueTreeState& apvts)
{
    ...
    auto makeAttachmentHeleper = [&params, &apvts](auto& attachment, const auto& name, auto& slider)
    {
        makeAttachment(attachment, apvts, params, name, slider);
    };

    makeAttachmentHeleper(inGainSliderAttachment, Names::Gain_In, *inGainSlider);

    makeAttachmentHeleper(lowMidXoverSliderAttachment, Names::Low_Mid_Crossover_Freq, *lowMidXoverSlider);

    makeAttachmentHeleper(midHighXoverSliderAttachment, Names::Mid_High_Crossover_Freq, *midHighXoverSlider);

    makeAttachmentHeleper(outGainSliderAttachment, Names::Gain_Out, *outGainSlider);
...
void GlobalControls::resized()
{
    ...
    auto spacer = FlexItem().withWidth(6);
