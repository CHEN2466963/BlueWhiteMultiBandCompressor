...
void CompressorBandControls::updateAttachments()
{
    ...
    auto makeAttachmentHeleper = [&params, &apvts = this-> apvts](auto& attachment, const auto& name, auto& slider)
    {
        makeAttachment(attachment, apvts, params, name, slider);
    };

    makeAttachmentHeleper(attackSliderAttachment, names[Pos::Attack], attackSlider);
    makeAttachmentHeleper(releaseSliderAttachment, names[Pos::Release], releaseSlider);
    makeAttachmentHeleper(thresholdSliderAttachment, names[Pos::Threshold], thresholdSlider);
    makeAttachmentHeleper(ratioSliderAttachment, names[Pos::Ratio], ratioSlider);
    makeAttachmentHeleper(bypassButtonAttachment, names[Pos::Bypass], bypassButton);
    makeAttachmentHeleper(soloButtonAttachment, names[Pos::Solo], soloButton);
    makeAttachmentHeleper(muteButtonAttachment, names[Pos::Mute], muteButton);
