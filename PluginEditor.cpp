...
void CompressorAudioProcessorEditor::updateGlobalBypassButton()
{
...
void CompressorAudioProcessorEditor::toggleGlobalBypassState()
{
...
std::array<juce::AudioParameterBool*, 3> CompressorAudioProcessorEditor::getBypassParams()
{
